...
import 'package:video_editor_git/Matrix_gesture_detector/matrix_gesture_detector.dart';
...
class _BlurDemoState extends State<BlurDemo> {
  ...
  void initState() {
    ...
    sharp = ImageData('assets/images/sharp.jpeg', imageLoaded);
    blur = ImageData('assets/images/blur.jpeg', imageLoaded);
...
class BlurPainter extends CustomPainter {
  ...
  void paint(ui.Canvas canvas, ui.Size size) {
    ...
    if (path == null) {
      ...
      path = parseSvgPathData('M8,15 C8,15 0,10 0,5 0,0 7,1 8,4 c1,-3 8,-4 8,1 0,5 -6,6 -8,10 z'); // CREATE HEART SHAPE
